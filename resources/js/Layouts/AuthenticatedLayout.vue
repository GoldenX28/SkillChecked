...
<template>
    <!-- Hide the standard authenticated header on admin pages to avoid duplicate headers covering admin controls -->
    <header v-if="!($page?.component?.startsWith('Admin/'))" class="w-full bg-white shadow-lg dark:bg-gray-800">
